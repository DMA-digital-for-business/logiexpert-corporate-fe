...
| Vuoi… | Cosa fare |
|---|---|
| Acquistare subito a prezzo di listino | Aggiungi al carrello → Checkout |
| Ottenere condizioni dedicate, quantità elevate o prodotti configurati | Aggiungi al preventivo → Richiedi preventivo |
| Ordinare con pagamento differito o ordine d'acquisto | Registrati come azienda e richiedi l'attivazione delle condizioni |
...
**Puoi navigare anche senza registrarti**, ma con un account azienda hai accesso a:

- il tuo listino dedicato, già applicato ai prezzi che vedi a catalogo;
- lo storico completo di ordini e preventivi;
- i metodi di pagamento concordati con noi (es. ordine d'acquisto, pagamento differito);
- indirizzi di fatturazione e consegna precompilati a ogni acquisto;
- più utenti sullo stesso account aziendale, con ruoli diversi.

---

## 2 · Registrati come azienda
...
> **L'indirizzo email è il dato più importante.** Diventa il tuo nome utente e il riferimento con cui ritrovi ordini e preventivi. Controllalo prima di inviare.
...
Naviga il catalogo per categoria o usa la ricerca. Nella pagina di ogni prodotto scegli la variante e la quantità, poi decidi come procedere:

- **Aggiungi al carrello** — per acquistare subito alle condizioni che vedi a schermo;
- **Aggiungi al preventivo** — per chiedere un'offerta dedicata su quei prodotti.
...
## 4A · Acquisto immediato — vai al checkout
...
|---|---|
| Carta di credito | Tutti |
| Bonifico bancario anticipato | Tutti |
| Ordine d'acquisto / pagamento differito | Aziende registrate con condizioni attive |

**Con carta di credito** l'ordine è confermato subito e ricevi l'email di riepilogo.

**Con bonifico anticipato** ricevi le nostre coordinate bancarie a schermo e via email. L'ordine resta in attesa fino alla verifica dell'accredito, poi passa in lavorazione.

**Con pagamento differito** l'ordine viene confermato subito e la fattura segue i termini concordati con la tua azienda.

---

## 4B · Richiesta di preventivo — come funziona
...
1. Il nostro team riceve la richiesta e prepara l'offerta.
2. Se non hai ancora un account aziendale, lo attiviamo noi: riceverai un'email per impostare la password.
3. Ricevi il preventivo via email e lo trovi nella tua area riservata.
...
## 5 · Segui il tuo ordine

Nella tua area riservata, sezione **Ordini**, trovi lo stato aggiornato di ogni acquisto. A ogni cambio di stato ricevi una notifica via email.

| Stato | Significato |
|---|---|
| In attesa di pagamento | In attesa dell'accredito del bonifico |
| Ordine accettato | Pagamento verificato, ordine acquisito |
...
**Devo registrarmi per acquistare?**
No, puoi completare un acquisto anche senza account. Ma senza registrazione non hai storico ordini, condizioni dedicate né pagamenti differiti.

**Ho chiesto un preventivo senza registrarmi. Lo perdo?**
...
Usa "Password dimenticata" nella pagina di accesso: riceverai un link per reimpostarla all'indirizzo email registrato.
...
### Note per la produzione della pagina web (da rimuovere prima della pubblicazione)

- Struttura consigliata: un blocco per passo, con titolo numerato, sintesi breve sempre visibile e accordion "Scopri di più" per il dettaglio — come nel riferimento Sidea.
- Prevedere uno screenshot o una breve clip per ciascuno dei passi 1, 2, 3, 4A, 4B, 5.
- Il bivio 4A / 4B va reso visivamente esplicito: due colonne affiancate, non due sezioni in sequenza.
- Il riquadro "Registrati con lo stesso indirizzo email" va replicato anche nel form di richiesta preventivo e nella pagina di conferma invio.
- Tutti i segnaposto `[CONTENUTO MANCANTE: ...]` vanno risolti con il cliente prima della pubblicazione.
